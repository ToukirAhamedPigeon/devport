  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[90vw] max-w-full shrink-0 rounded-2xl border border-b-0 border-zinc-200 bg-[linear-gradient(180deg,#fafafa,#f5f5f5)] p-5 md:p-16 md:w-[60vw] dark:border-slate-800"
            key={idx}
            style={{
            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <div className="me-3">
                    <img src="/profile.svg" alt={item.name} className="w-10 h-10 rounded-full" />
                  </div>
