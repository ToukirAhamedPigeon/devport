  ...
  return (
    <footer className="w-full mb-10 pb-10" id="contact">
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-white-200 md:mt-10 my-6 text-center">Reach out to me today and let&apos;s discuss how I can help you achieve your goals.</p>
        <a href="mailto:toukir.ahamed.pigeon@gmail.com">
      ...
      <div className="flex flex-col md:flex-row justify-between mt-16 items-center">
        <p className="md:text-base text-sm md:font-normal font-light">Copyright &copy; {new Date().getFullYear()} Pigeonic. All rights reserved.</p>
